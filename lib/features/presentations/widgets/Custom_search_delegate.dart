...
import 'package:flutter_food/features/presentations/widgets/search_result.dart';
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    ...
    print('Inside custum search delegate  and search query  is ${query}');

    BlocProvider.of<PersonSearchBloc>(context, listen: false)
      ..add(PersonSearch(query));
